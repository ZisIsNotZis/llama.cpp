...
| `--tui, --no-tui` | show a live TUI dashboard (sequences, memory, throughput) on stdout when it is a terminal (default: enabled, auto-disabled when stdout is not a tty)<br/>(env: LLAMA_ARG_TUI) |
